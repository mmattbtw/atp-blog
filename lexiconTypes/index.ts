...
export class FmTealAlphaFeedNS {
  ...
  getPlay<AV extends AuthVerifier<any, any>>(
    cfg: ConfigOf<
      AV,
  ...
  getActorFeed<AV extends AuthVerifier<any, any>>(
    cfg: ConfigOf<
      AV,
...
export class FmTealAlphaActorNS {
  ...
  getProfile<AV extends AuthVerifier<any, any>>(
    cfg: ConfigOf<
      AV,
  ...
  searchActors<AV extends AuthVerifier<any, any>>(
    cfg: ConfigOf<
      AV,
  ...
  getProfiles<AV extends AuthVerifier<any, any>>(
    cfg: ConfigOf<
      AV,
...
export class FmTealAlphaStatsNS {
  ...
  getUserTopArtists<AV extends AuthVerifier<any, any>>(
    cfg: ConfigOf<
      AV,
  ...
  getTopReleases<AV extends AuthVerifier<any, any>>(
    cfg: ConfigOf<
      AV,
  ...
  getLatest<AV extends AuthVerifier<any, any>>(
    cfg: ConfigOf<
      AV,
  ...
  getUserTopReleases<AV extends AuthVerifier<any, any>>(
    cfg: ConfigOf<
      AV,
  ...
  getTopArtists<AV extends AuthVerifier<any, any>>(
    cfg: ConfigOf<
      AV,
